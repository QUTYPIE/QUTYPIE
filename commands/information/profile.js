...
module.exports = {
  ...
  run: async (client, message, args, guildData, player, prefix) => {
      ...
      const destroyer = user.id === "336007991574659074" ? true : false;
      let badges2 = "";
     ...
     if(destroyer === true || user.id === "336007991574659074") badges = badges + `\n\<:stolen_emoji:1034497415555850300>・**[Destroyer </>](https://discord.com/users/336007991574659074)**`;
    
      if(bxby === true || user.id === "336007991574659074") badges = badges + `\n<a:developer:1025670347992879166>・**Developer**`;
try{
      
const fyp = sus.roles.cache.has("1033593584865263616");
...
const own = sus.roles.cache.has("1033593585624428585");
   ...
   //   if(spons === true) badges = badges + `\n:xeta_sponsor: Sponsor`;
      ...
      const han = sus.roles.cache.has("1033593586257772686");
  ...
  //if(gbug === true) badges = badges + `\n:xeta_hunter_gold: Bug Hunter Prime`;
      ...
      const manager = sus.roles.cache.has("1033593587889348660");
      if(manager === true) badges = badges + `\n<:stolen_emoji:1023989834282434600>・**Mod**`;

     const aman = sus.roles.cache.has("1033593590351413280");
      ...
      const supp = sus.roles.cache.has("1033593591643254884");
      if(supp === true) badges = badges + `\n<:EarlySupporter:1025671922966614036>・**Supporter**`;

      const fr = sus.roles.cache.has("1033593593757171752");
...
.setTimestamp()
.setDescription(`
**BADGES** <a:Boost_badges:1025675657625223268>
