...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    try{
      ...
      message.reply({embeds: [new MessageEmbed().setColor(client.color).setDescription(`<:CyanTick:1027951432151879720> | Successfully undeafened <@${member.user.id}> From Voice!`)]})
    }catch(err){
